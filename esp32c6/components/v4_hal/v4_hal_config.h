/**
 * @file v4_hal_config.h
 * @brief V4-hal component configuration
 *
 * This header disables ESP-IDF internal macro self-tests that fail with
 * certain C++ standard/GCC version combinations when including driver headers.
