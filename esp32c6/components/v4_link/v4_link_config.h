/**
 * @file v4_link_config.h
 * @brief V4-link component configuration
 *
 * This header disables ESP-IDF internal macro self-tests that fail with
 * certain C++ standard/GCC version combinations when including UART headers.
